    ...
    <div>
      ...
      <main className='overflow-hidden'>
        ...
        <section id='home' className={styles.secondSection}>
          ...
          <article className='relative flex justify-center px-4 lg:px-28 flex-col items-left gap-8 text-white py-14 md:gap-12 min-h-screen layout'>
            <img className='w-64 h-auto right-0 -bottom-32 absolute' src='/ellipse1.png' alt='' />
            <div className='flex flex-col lg:flex-row'>
              <div className='lg:w-1/2'>
                <div>
                  <h1 className='text-2xl md:text-3xl mb-8 text-left'>THE 2022 CHALLENGE<br /><span className='font-bold text-4xl md:text-5xl'>LOREM IPSUM D</span></h1>
                ...
                <div className='z-10 mt-6 self-center lg:self-start'>
                  <UnstyledLink href='#' className={`text-lg md:text-xl ${styles.thirdBtn}`}>Join the Community!</UnstyledLink>
                </div>
              </div>
        ...
        <section id='timeline' className={styles.thirdSection}>
          <article className='flex flex-col relative pl-28 justify-center items-left gap-2 text-white md:gap-24 min-h-screen layout'>
              <h1 className='top-8 absolute font-bold text-4xl text-left'>PROGRAM<br />TIMELINE</h1>
          ...
          <UnstyledLink href='#' className={styles.fourthBtn}>Competition Guideline</UnstyledLink>
        </section>
        <section id='register' className={styles.fourthSection}>
          <article className='relative flex lg:flex-row justify-between px-0 flex-col lg:items-center text-black lg:h-screen min-h-screen layout'>
            <div className='py-20 lg:py-0 px-4 sm:px-24 lg:px-0 m-auto lg:w-1/2'>
                <div>
                  ...
                  <p className='text-lg w-80 leading-6'>A platform for ITS students who are highly motivated in making an impact.</p>
                </div>
                <div className='flex mt-7 gap-10'>
                  <UnstyledLink href='#' className={styles.fifthBtn}>Join the Community!</UnstyledLink>
                </div>
            </div>
        ...
        <section id='about' className={styles.fifthSection}>
          <article
            ...
            className='bg-cover bg-center relative flex px-0 flex-col justify-center items-left gap-8 text-white md:gap-12 min-h-screen layout'
          >
              ...
              <div className='px-4 md:px-28'>
                ...
                <div className='mt-7 gap-10'>
                  ...
                  <div className='flex flex-col md:flex-row gap-6'>
                    <UnstyledLink href='#' className={`self-start ${styles.fifthBtn}`}>Download the video</UnstyledLink>
        ...
        <div className='bg-white flex flex-col h-64 w-full'>
          <div className={styles.footer1}>
            <h1 className='text-5xl text-white font-bold text-center'>ARE YOU READY TO #CreateTheChange?</h1>
          </div>
          <div className={styles.footer2}>
            <h1 className='text-4xl font-bold text-center'>Stay Connected!</h1>
